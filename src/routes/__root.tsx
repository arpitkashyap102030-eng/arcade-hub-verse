...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "3CR Arcade — Free-to-Play Crash & Skill Games" },
      {
        name: "description",
        content:
          "3CR Arcade is a free-to-play games hub. Play Aviator, Chicken Road, Tower Rush, Mines and more with virtual coins. No real money, ever.",
      },
      { property: "og:title", content: "3CR Arcade" },
      { property: "og:description", content: "Free-to-play crash and skill games with virtual coins." },
      ...
      { name: "apple-mobile-web-app-title", content: "3CR" },
    ],
    links: [
